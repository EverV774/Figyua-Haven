...
public class CProductos {
    ...
    public void agregarProducto(JTextField nombre, JTextField ancho, JTextField largo, JTextField precio){
        CConexion objC = new CConexion();
        
        String accion="insert into Productos (nombre,ancho,largo,precio) values (?,?,?,?);";
    ...
    public void mostrarProductos(JTable tablaProductos){
        ...
        sql = "select productos.id, productos.nombre, productos.ancho, productos.largo, productos.precio from productos;";
        ...
        try{
            ...
            while (rs.next()){
                ...
                modelo.addRow(new Object[] {id, nombre, ancho, largo, precio});
            }
            tablaProductos.setModel(modelo);
    ...
    public void Seleccionar (JTable totalP, JTextField id, JTextField nombre, JTextField ancho, JTextField alto, JTextField precio){
    ...
    public void modificarProducto(JTextField id,JTextField nombre, JTextField ancho, JTextField largo, JTextField precio){
        CConexion objC = new CConexion();
        String accion="update Productos SET productos.nombre=?, productos.ancho=?, productos.largo=?, productos.precio=? WHERE productos.id=?;";
