...
public class LoginEmpresa extends javax.swing.JFrame {
    ...
    public LoginEmpresa() {
        ...
        icono = new ImageIcon("imagenesL/c1.png");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(rn==true&&rap==true&&ram==true&&rg==true&&rang==true&&rc==true&&ru==true&&rusu==true&&rc1==true&&rc2==true){
            almacenador.agregarUsuario(n, ap, am, g, JCalendario.getDate(), txtCorreo.getText(),txtUsu.getText(),txtContrasena2.getText(),r);
    ...
    private void IngresarInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IngresarInActionPerformed
        ...
        if (usuario.equals("")){
            lblError2.setText("Ingrese un Usuario");
        ...
        if (u==true && c==true && co==true){
            char rango = almacenador.encontrarUsuario(usuario, correo, contrasena);
            if (rango == 'c'){
            ...
            if (rango == 'e'){
               Interfaz empleado = new Interfaz();
            ...
            if (rango == 'n'){
                lblError3.setText("El usuario/correo no se encontró o la contraseña es incorrecta");
                lblError3.setForeground(RED);
            }
        }
